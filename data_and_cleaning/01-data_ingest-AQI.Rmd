...
```{r}
n_occur <- data.frame(table(combined_AQI$date))
n_occur[n_occur$Freq > 1,]

combined_AQI[combined_AQI$date %in% n_occur$Var1[n_occur$Freq > 1],]

# no duplicate dates, each row is a unique observation
```
