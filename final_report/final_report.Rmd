...
Notably, the percent of essential workers in a given county had by far the largest effect on average cases. Indeed, for every percent of workers in a county that could be classified as essential average cases will increase by about 164. The estimates for number of individuals with health insurance and average vaccinations administered were both much lower at .039 and .035, respectively. Despite being statistically significant, the estimates for these variables are small enough that they might lack practical significance in the context of our analysis. The next section will 
